...
/**
 * \brief Demo of all the data types and generally available publishers.
 */
int main(int /* argc */, char ** /* argv */) {
	...
	// try individual publishers from the factory class.
	...
	std::shared_ptr< adc::publisher_api > p3 = f.get_publisher("curl");
	std::cout << test_publisher(p3, b, curl_config) << std::endl;
	...
	std::shared_ptr< adc::publisher_api > p5 = f.get_publisher("script");
	std::cout << test_publisher(p5, b, script_config) << std::endl;
...
int main(int argc, char **argv)
{
	return adc_examples::demoBuilder::main(argc, argv);
}
